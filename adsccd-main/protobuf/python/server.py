...
# print final stats
print(f'nb female: {nb_female} .')
print(f'nb male: {nb_male} .')
print(f'mean female size in cm: {mean_female_size_in_cm} .')
print(f'mean male size in cm: {mean_male_size_in_cm} .')
